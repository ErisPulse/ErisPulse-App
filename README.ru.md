...
**Запускайте ErisPulse на Android, Windows и Linux — несколько экземпляров, нативный интерфейс, работа в фоне.**
...
Android выпущен; настольные сборки Windows / Linux в разработке. Единая кодовая база Flutter для всех платформ.
...
> Настольные сборки Windows / Linux в разработке.
